...
class ThreeLayerConvNet(object):
    ...
    def __init__(
        ...
        # The conv layer preserves H, W and the 2x2/stride-2 pool halves each of
        # them, so the flattened volume feeding the hidden affine layer is
        # num_filters * (H // 2) * (W // 2).
