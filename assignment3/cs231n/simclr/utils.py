...
def train(model, data_loader, train_optimizer, epoch, epochs, batch_size=32, temperature=0.5, device='cuda'):
    ...
    for data_pair in train_bar:
        ...
        ##############################################################################
        # The model returns (normalized feature, normalized projection output); the
        # contrastive loss lives in the projection space, i.e. out_left/out_right
        # are the z-vectors of the two branches.
